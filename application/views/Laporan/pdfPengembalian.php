...
$table1 .= '<tr>
                <td style="text-align:center; font-family: sans-serif; font-size:24px; font-weight:bold;">LAPORAN PENGEMBALIAN</td>
            </tr>';
$table1 .= '</table> <br/><br/>';

$table2 = '<table border="1" width="650px">';
$table2 .= '<tr style="background-color: lightblue;">
                <td height="30" style="text-align:center; font-weight:bold; font-family:sans serif; font-size:14px">ID Peminjam</td>
                ...
                <td style="text-align:center; font-weight:bold;font-family:sans serif; font-size:14px;">Tanggal Pengembalian</td>
                <td style="text-align:center; font-weight:bold;font-family:sans serif; font-size:14px;">Tanggal Kembalikan</td>
            </tr>';

foreach ($data as $row) {
    $table2 .= '<tr>
                <td height="30" style="text-align:center;  font-family:sans-serif; font-size:12px;">' . $row->id_kembali . '</td>
