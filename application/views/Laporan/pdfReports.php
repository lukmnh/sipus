...
$table1 .= '<tr>
                <td style="text-align:center; font-family: sans-serif; font-size:24px; font-weight:bold;">LAPORAN PEMINJAMAN</td>
            </tr>';
$table1 .= '</table> <br/><br/>';
...
foreach ($data as $row) {
    $table2 .= '<tr>
                <td height="30" style="text-align:center;  font-family:sans-serif; font-size:12px;">' . $row->id_pinjam . '</td>
