...
<body>
    <div class="card-body">
        <form method="post" action="<?= base_url(); ?>laporan/peminjam">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <a href="<?= base_url() ?>Laporan/peminjam" class="btn btn-warning btn-block btn-refresh"><i class="fa fa-retweet"></i>Refresh</a>
                </div>
                <div class="col-md-1">
                    <a href="<?= base_url() ?>Laporan/pdfReports" class="btn btn-danger btn-block btn-lihat" target="_blank"><i class="fa fa-file-pdf"></i>&nbsp;PDF</a>
                </div>
            </div>
            <br>
